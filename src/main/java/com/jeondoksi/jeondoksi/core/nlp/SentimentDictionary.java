...
public class SentimentDictionary {
    ...
    private void initializeDictionary() {
        ...
        addWords(2, "슬프", "우울", "비참", "고통", "화나", "무섭", "끔찍", "나쁘", "절망", "실패",
                ...
                "내려앉", "지워", "짐", "쓸모 없", "외로움", "결핍", "충돌", "흔들리", "찔렀");
    ...
    // --- Strong Action Verbs ---
    private final java.util.Set<String> strongActionVerbs = java.util.Set.of(
            "도전", "실천", "해결", "극복", "나아가", "움직이", "바꾸", "시작", "결심", "선택",
            "행동", "실행", "달성", "성취", "돌파", "개척", "모험", "탐험", "발견", "창조",
            "혁신", "변화", "성장", "발전", "진보", "추진", "진행", "완수", "쟁취", "투쟁",
            "싸우", "이기", "승리", "극복", "타파", "쇄신", "개혁", "변혁", "재건", "부활",
            "탈출", "해방", "구원", "구출", "보호", "지키", "방어", "수호", "건설", "건립",
            "제작", "생산", "창작", "저술", "집필", "연구", "개발", "발명", "고안", "기획",
            "계획", "설계", "조직", "운영", "경영", "관리", "감독", "지휘", "통솔", "리드",
            "주도", "선도", "솔선", "참여", "동참", "협력", "지원", "원조", "기여", "공헌",
            "헌신", "봉사", "희생", "노력", "분투", "매진", "정진", "연마", "수련", "단련",
            "훈련", "연습", "학습", "공부", "독서", "탐구", "사색", "성찰", "반성", "회개",
            "용서", "화해", "소통", "대화", "설득", "타협", "협상", "체결", "계약", "약속",
            "맹세", "다짐", "각오", "의지", "열정", "용기", "희망", "꿈", "목표", "목적",
            "방향", "길", "여정", "여행", "항해", "비행", "질주", "도약", "비상", "상승");

    public boolean isStrongActionVerb(String morph) {
        // 형태소의 기본형이 strongActionVerbs에 포함되는지 확인
        // 예: "나아가다" -> "나아가" (Komoran 분석 결과에 따라 다를 수 있음, 보통 어근 위주)
        // Komoran은 "나아가다"를 "나아가" + "다"로 분석하거나 "나아가다" 자체로 볼 수 있음.
        // 여기서는 포함 여부만 체크
        return strongActionVerbs.stream().anyMatch(morph::contains);
    }
}
